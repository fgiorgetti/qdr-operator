// Utility methods for dealing with common Slices operations
package utils

import "sort"

// Compares two sorted slices and validate both are not nil
// and all elements from given model are present on the target
// instance.
...
// Returns an interface array with sorted elements from int array
...
// Returns an interface array with sorted elements from string array
